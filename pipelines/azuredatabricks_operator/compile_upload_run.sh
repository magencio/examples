...
function show_usage() {
    ...
    echo -e "\t--pipeline-name\t(Optional) Pipeline parameters (e.g. '[{\"name\":\"run-name\",\"value\":\"test-run\"},{\"name\":\"parameter\",\"value\":\"10\"}]')"
}
...
read -p "Pipeline started... press any key to delete the pipeline:"
